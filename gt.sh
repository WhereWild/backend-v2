...
docker compose --project-directory "$project_dir" exec -it --user "$(id -u):$(id -g)" gdal bash -lc ". /workspace/docker/aliases.sh 2>/dev/null || true; b2-mount 2>/dev/null || true; exec /bin/bash"
